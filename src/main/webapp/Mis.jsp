<%-- 
    Document   : Mis
    Created on : 10 mar 2023, 13:11:15
    Author     : USUARIO
--%>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex">
                            <div class="d-flex d-flex-grow-1">
                                ...
                                <a href="#" class=" align-self-center bg-bluee text-decoration-none">annitas</a>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <p><button type="submit" class="btn btn-primary w-20 bg-bluey border-0 md-2">Editar</button>
                            <button type="submit" class="btn btn-primary w-20 bg-bluey border-0 md-2">Eliminar</button>
                        </p>
                        </div> 
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="bg-bluee">Cómo es posible amar tanto la soledad y a la vez desear tener alguien con quien compartirla.
                                ...
                                <p>
                                    <button type="submit" class="btn btn-primary w-20 bg-bluey border-0 md-2">Editar</button>
                                <button type="submit" class="btn btn-primary w-20 bg-bluey border-0 md-2">Eliminar</button>
                                </p>
                        </div> 
                    </div>
