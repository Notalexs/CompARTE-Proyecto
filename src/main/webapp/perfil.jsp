<%-- 
    Document   : perfil
    Created on : 10 mar 2023, 13:11:38
    Author     : USUARIO
--%>
               ...
               <div class="row">
                   ...
                   <div class="col-lg-8">
                       <div class="card" style="background-color: #fffecdd9 ;">
                           ...
                           <a class=" align-self-center bg-bluee ">Ana Luisa Rodriguez Martinez</a>
   
                           <div class="card-body">
                            
                               <p class="letra" style="text-align: center; font-size: 20px;">Descripción</p>
                               <p class="bg-bluee" style="text-align: center;">Estudiante de diseño gráfico. Me gustan mucho los perros, los poemas y juego de tronos</p>
                           
                               <p class="letra" style="text-align: center; font-size: 20px;">Datos</p>
                            <p class="bg-bluee" style="text-align: left;">Email: anitas@hotmail.com  
                                <label class="bg-bluee" style="padding-left: 250px;">Edad: 20 años</label></p>
                             ...
                             <div class="card-body">
                                ...
                                <button onclick="location.href='EditarPerfil.jsp'" type="submit" class="btn btn-primary w-20 bg-bluey border-0 md-2">Editar</button>
                                <button onclick="location.href='Mis.jsp'" type="submit" class="btn btn-primary w-20 bg-bluey border-0 md-2">Publicaciones</button>
                             </div> 
